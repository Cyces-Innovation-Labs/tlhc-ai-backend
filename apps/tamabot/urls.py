...
from apps.tamabot.views import NewThreadAPIView,TamaResponseAPIView,RetrieveMessageAPIView,FeedbackMessageAPIView,ListThreadsViewSet,ValidationViewSet
...
urlpatterns = [
    ...
    path(f"{API_URL_PREFIX}validation/", ValidationViewSet.as_view(), name="feedback"),
